<script>
	...
	const errorMessages = {
		not_a_member: 'You are not registered as a club member. If this is a mistake, please contact your club leader.',
...
<svelte:head>
	<title>Member Login - Club Leaders Portal</title>
</svelte:head>


<div class="container">
	<div class="login-card">
		<h1 class="title">Club Member Login</h1>
